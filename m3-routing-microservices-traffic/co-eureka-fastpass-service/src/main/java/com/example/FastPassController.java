...
public class FastPassController {
	...
	public FastPassController() {
		...
		FastPassCustomer fc1 = new FastPassCustomer("100", "Suchita Vinchurkar", "555-123-4567", new BigDecimal("19.50"));
		FastPassCustomer fc2 = new FastPassCustomer("101", "Neha Parate", "555-321-7654", new BigDecimal("11.25"));
		FastPassCustomer fc3 = new FastPassCustomer("102", "Isha Pathrabe", "555-987-6543", new BigDecimal("35.00"));
